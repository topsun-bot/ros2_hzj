...
- Humans merge; agents stop before merge/production (wiki3 §13(6) CI + gray). No auto-merge.
...
- [docs/architecture/feishu-ci-gray.md](docs/architecture/feishu-ci-gray.md) — wiki3 §13(6) CI + gray process gate (required checks green + humans merge + no auto-merge; no vendor compile; no XML)
