...
test -f docs/architecture/feishu-memory-hold.md
test -f AGENTS.md
...
test -f scripts/check_memory_hold.py
...
- [feishu-memory-hold.md](feishu-memory-hold.md) — 《通信中间件》memory 层 Hold（不落地 Loaned / Data Sharing / Iceoryx / Agnocast；AUTO ≠ zero-copy）
