...
test -f docs/architecture/feishu-one-layer.md
test -f AGENTS.md
...
test -f scripts/check_one_layer.py
...
- [feishu-one-layer.md](feishu-one-layer.md) — wiki3 §13(5) 一次一层过程闸（下一层另开 PR；不捆绑 Cega+memory+XML；#41 may still be open）
