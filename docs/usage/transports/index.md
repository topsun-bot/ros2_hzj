...
> **Repo note.** This page is R0 reference copied from [`topsun-bot/topsun_dimos`](https://github.com/topsun-bot/topsun_dimos) (PR [#122](https://github.com/topsun-bot/topsun_dimos/pull/122)). Examples, assets, CI snippets, and most `dimos.*` imports below still belong to the DimOS monorepo. A dual-chain **subset** is now under [`dimos_bridge/`](../../../dimos_bridge/) (not the whole tree). Dual-chain contract: [R0 interface freeze](../../architecture/ros2-dds-r0-interface-freeze.md). Bench howto (no scores): [benchmark-dds.md](../benchmark-dds.md). DimOS default transport is LCM (out of DDS scope here).
...
| `DDS`          | Cyclone DDS without ROS (WIP)       | Yes           | Yes     | WIP. Dual-chain map + R0 freeze: [ros2-dds-r0-interface-freeze](../../architecture/ros2-dds-r0-interface-freeze.md) |
