...
Sourced chain_a.sh (RMW=rmw_fastrtps_cpp, ROS_DOMAIN_ID=42). ROS setup=/opt/ros/humble/setup.bash. pytest exit=0. pingpong exit=0. Topology=same-process. BENCH_SIZES=102400,262144,1048576. BENCH_INTERVAL_MS=100. BENCH_ROS_MSG=uint8_multiarray. Honesty check only — do not tune. Knob: additive user SHM shm_midsize maxMessageSize=280000 segment_size=2097152; builtin transports kept. Do not compare with Chain B. Not real-robot / Feishu-field / cross-host proof.
