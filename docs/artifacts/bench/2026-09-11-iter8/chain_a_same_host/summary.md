...
|------|-------------|----------|---------|----------|----------|----------|----------|-----|-----|
| `ros_high_throughput` | 64 B | 5.0 | 400 | 0 | 884.82 | 1104.4 | 1145.1 | 517.09 | 1284.5 |
| `ros_reliable` | 64 B | 5.0 | 400 | 0 | 745.59 | 1030.5 | 1138.7 | 380.74 | 1170.8 |
...
|------|-------------|-------------|-------------|-----------|-----------|-------------|---------------|---------------|-------------|-------------|---------------|---------------|
| `ros_high_throughput` | 64 B | 219.59 | 260.28 | 137.00 | 5090.9 | 34.09 | 171.83 | 212.02 | 47.14 | 193.00 | 448.24 | 596.52 |
| `ros_reliable` | 64 B | 284.91 | 393.09 | 148.53 | 5085.2 | 88.43 | 166.43 | 236.06 | 23.29 | 237.54 | 457.02 | 625.46 |
...
`BENCH_SKIP_PYTEST=1`。**64 B / 200 Hz / 5 ms**. Primary = jitter (RTT p95/p99 + arrival interval). same-host is the primary table. Probe `leaseAnnouncement` 15 s vs iter7: BestEffort arrival \|I−5 ms\| p95 **375→448 — not kept**. Repeat lost the official RTT p95 win. 0/400 timeouts. 不要和链 B 混表。不是飞书 / 实机根因。
