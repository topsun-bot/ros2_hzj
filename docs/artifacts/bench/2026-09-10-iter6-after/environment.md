...
- **git SHA ros2_hzj (at remasure):** `2d904a5` (`port_queue_capacity` 64 on `shm_midsize`)
- **Probe (not kept):** `<port_queue_capacity>64</port_queue_capacity>`. XMLPARSER accepted it (empty pingpong stderr). Reverted after remasure.
